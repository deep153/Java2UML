...
public class Converter {
   ...
   String plantUMLText,individualPlantUMLText,fullPlantUMLText, desc ,svg,sequenceText;
   static HashMap<String, String> sequencePlantUML = new HashMap<String, String>();

  public Converter( String data) throws Exception {
	   
	   String usercode = null;
	   
		try {
			BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\USER\\Documents\\NetBeansProjects\\Java2Uml\\src\\visualizer\\code.txt"));
         ...
         //plantUMLText = createPlantUMLFromSourceCode(usercode);
         fullPlantUMLText = createFullPlantUMLFromSourceCode(usercode);
         //individualPlantUMLText = createPlantUMLForIndividualClasses();
         sequenceText = createSequenceDiagramText();
         System.out.println(""+sequenceText);
        
         Image_Generator im=new Image_Generator(sequenceText);
         im.genretate();
        
         
      /*   
        SourceStringReader reader = new SourceStringReader(fullPlantUMLText);
		
		final ByteArrayOutputStream os = new ByteArrayOutputStream();
	        desc = reader.generateImage(os);
		os.close();
                
                OutputStream o=new FileOutputStream("C:\\Users\\USER\\Documents\\NetBeansProjects\\Java2Uml\\src\\visualizer\\b.png");
        ...
        */        
		...
		//System.out.println(svg);System.exit(0);
   ...
   static String createPlantUMLForIndividualClasses(){
       JsonArrayBuilder builder = Json.createArrayBuilder();
       for(String className:individualClassDiagramList.keySet()){
           JsonObjectBuilder jpb = Json.createObjectBuilder().add(className, individualClassDiagramList.get(className));
           builder.add(jpb);
       }
       individualClassDiagramList.clear();
       return builder.build().toString();
   }
   
   static String createSequenceDiagramText() {

        String r = (String) sequencePlantUML.get("sequenceUMLKey");
        sequencePlantUML.clear();
        return r;
    }
   
   static String createPlantUMLFromSourceCode(String userCode){
       try{
           ...
           userCode = removeSourceFileCommentsAndGenerics(userCode);
           ...
           while(matcher.find()) {
               ...
               Set<String> interfaces = extractParentInterfaces(matcher.group(5));
   ...
   static String createFullPlantUMLFromSourceCode(String userCode){
       try{
           String END_PLANTUML = "@enduml";
           String START_PLANTUML = "@startuml";
           String classKey = "class ";
   ...
   private static Set<String> extractParentInterfaces(String parentsString){
